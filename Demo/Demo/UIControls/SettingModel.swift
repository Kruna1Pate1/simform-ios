    ...
    static func dummySettings(for category: String) -> [Setting] {
        ...
        case "Network":
            return [
                ...
                Setting(icon: UIImage(named: "blutooth"), title: "Bluetooth", isSwitched: true),
        ...
        case "Accessibility":
            return [
                ...
                Setting(icon: UIImage(named: "sun"), title: "Display & brightness"),
        ...
        case "Security":
            return [
                ...
                Setting(icon: UIImage(named: "eye"), title: "Privacy"),
